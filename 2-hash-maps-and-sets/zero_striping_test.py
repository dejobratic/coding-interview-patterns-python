...
class TestZeroStriping:
    ...
    def test_matrix_with_no_zeros_is_unchanged(self):
        # arrange
        matrix = [
            [1, 2, 3],
            [4, 5, 6],
    ...
    def test_single_zero_sets_entire_row_and_column_to_zero(self):
        # arrange
        matrix = [
            [1, 2, 3],
            [4, 0, 6],
    ...
    def test_multiple_zeros_in_different_rows_and_cols(self):
        # arrange
        matrix = [
            [1, 2, 3, 4, 5],
            [6, 0, 8, 9, 10],
    ...
    def test_zeros_in_first_row_and_first_col(self):
        # arrange
        matrix = [
            [0, 2, 3],
            [4, 5, 6],
