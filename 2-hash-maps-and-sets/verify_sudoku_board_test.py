...
class TestVerifySudokuBoard:
    ...
    def test_valid_partially_filled_board_is_valid(self):
        # arrange
        board: Board = [
            [5, 3, 0, 0, 7, 0, 0, 0, 0],
            [6, 0, 0, 1, 9, 5, 0, 0, 0],
    ...
    def test_duplicate_in_a_row_is_invalid(self):
        # arrange
        board: Board = [[0] * 9 for _ in range(9)]
        board[0][0] = 5
        board[0][8] = 5
    ...
    def test_duplicate_in_a_column_is_invalid(self):
        # arrange
        board: Board = [[0] * 9 for _ in range(9)]
        board[1][3] = 7
        board[8][3] = 7
    ...
    def test_duplicate_in_a_3x3_grid_is_invalid(self):
        # arrange
        board: Board = [[0] * 9 for _ in range(9)]
        board[0][0] = 9
        board[2][2] = 9
    ...
    def test_given_example_board_is_invalid(self):
        # arrange
        board: Board = [
            [3, 0, 6, 0, 5, 8, 4, 0, 0],
            [5, 2, 0, 0, 0, 0, 0, 0, 0],
